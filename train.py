...
parser.add_argument('--dataset', default='GTA_IM', help='PROX,GTA_IM')
...
parser.add_argument('--l_norm', type=float, default=0.01, help='weight of norm')
parser.add_argument('--l_cos', type=float, default=0.01, help='weight of cos similarity')
# Training specifc parameters
parser.add_argument('--log_frq', type=int, default=32, help='frequency of logging')
...
parser.add_argument('--tag', default='NA', help='Personal tag epx')
parser.add_argument('--eval_only', action="store_true", default=False, help='evaluate the model')
parser.add_argument('--torso_joint', type=int, default=13, help='center of torso, 13 for GTA-IM')  # 19 16
    ...
    def eval_metrics():
        ...
        with torch.no_grad():  # Faster without grad
            for cnt, batch in enumerate(loader_val):
                ...
                loss_val += ECLoss(V_pred, y, m).item()
